...
use crate::constants::MAX_USAGE_COMPUTATION_CIPHERTEXTS;
...
/// SIZE: 8 + 32 + 32 + 8 + 8 + (32 * 13) + 1 + 16 + 32 + 1 + 8 + 1 = 563 bytes
#[account]
pub struct UsageReport {
    ...
    pub computation_ciphertext: [[u8; 32]; MAX_USAGE_COMPUTATION_CIPHERTEXTS], // 416
    pub ciphertext_count: u8,                                                  // 1
...
impl UsageReport {
    ...
    pub const SIZE: usize =
        8 + 32 + 32 + 8 + 8 + (32 * MAX_USAGE_COMPUTATION_CIPHERTEXTS) + 1 + 16 + 32 + 1 + 8 + 1;
}
